...
st.sidebar.write(" ")
st.sidebar.write(" ")
st.sidebar.markdown('This web application was developed by Chananchai Chanmol and is a part of 
                     AI Builders 2024 program, organized by VISTEC, Central Digital and Mahidol University.')
